...
// @Slf4j
// public class OldProjectServiceImpl implements OldProjectService {
...
//      */
//     @Override
//     public IPage<OldProjectVO> getProjectList(
//         int page,
//         int size,
//         String keyword,
...
//                     .in(OldProjectApplication::getProjectId, allProjectIds)
//                     .eq(OldProjectApplication::getIsDeleted, false)
//             );
//             for (OldProjectApplication app : applications) {
...
//         // 组装VO（和原来一样）
//         List<OldProjectVO> voList = new ArrayList<>();
//         for (Integer pid : filteredProjectIds) {
//             OldProjectVO vo = new OldProjectVO();
...
//             // 新增：查找该用户在该项目下的申请id
//             if (userId != null) {
//                 LambdaQueryWrapper<OldProjectApplication> appQuery = new LambdaQueryWrapper<>();
//                 appQuery.eq(OldProjectApplication::getProjectId, pid)
//                         .eq(OldProjectApplication::getUserId, userId)
//                         .eq(OldProjectApplication::getIsDeleted, false);
//                 OldProjectApplication app = projectApplicationMapper.selectOne(appQuery);
...
//         List<OldProjectVO> voListPage = new ArrayList<>();
...
//             if (userId != null) {
//                 LambdaQueryWrapper<OldProjectApplication> appQuery = new LambdaQueryWrapper<>();
//                 appQuery.eq(OldProjectApplication::getProjectId, project.getId())
//                         .eq(OldProjectApplication::getUserId, userId)
//                         .eq(OldProjectApplication::getIsDeleted, false);
//                 OldProjectApplication app = projectApplicationMapper.selectOne(appQuery);
//                 vo.setApplicationId(app != null ? app.getId() : null);
...
//             voListPage.add(vo);
//         }
//         Page<OldProjectVO> voPage = new Page<>(page, size, total);
...
//     @Override
//     @Transactional
//     public OldProjectVO createProject(OldProjectCreationDTO projectCreationDTO, UserDetails userDetails) {
//         // 1. 获取当前登录用户
...
//      */
//     @Override
//     public OldProjectVO getProjectById(Integer id) {
...
//     @Override
//     @Transactional
//     public OldProjectVO updateProject(Integer id, OldProjectCreationDTO projectCreationDTO, UserDetails userDetails) {
//         // 获取项目
//         Project project = projectMapper.selectById(id);
//         if (project == null || project.getIsDeleted()) {
//             throw new BusinessException("项目不存在");
...
//      */
//     @Override
//     public OldProjectVO convertToVO(Project project) {
//         OldProjectVO vo = new OldProjectVO();
//         BeanUtils.copyProperties(project, vo);
...
//     @Override
//     public List<OldProjectMemberVO> getProjectMembers(Integer projectId) {
//         // 1. 查出所有未删除的成员
//         List<OldProjectMember> members = projectMemberMapper.selectList(
//             new QueryWrapper<OldProjectMember>()
//                 .eq("project_id", projectId)
//                 .eq("is_deleted", 0)
//         );
//         List<OldProjectMemberVO> result = new ArrayList<>();
//         for (OldProjectMember member : members) {
//             OldProjectMemberVO vo = new OldProjectMemberVO();
...
//             OldProjectApplication application = projectApplicationMapper.selectOne(
//                 new QueryWrapper<OldProjectApplication>()
