...
- 状态码: 200 OK
- 响应包含token
- 设置环境变量: teacher_token = 响应中的token值
...
- 状态码: 200 OK
- 响应包含token
- 设置环境变量: enterprise_admin_token = 响应中的token值
...
- 状态码: 200 OK
- 响应包含token
- 设置环境变量: enterprise_mentor_token = 响应中的token值
...
- 状态码: 200 OK
- 响应包含token
- 设置环境变量: student_token = 响应中的token值
...
- 状态码: 201 Created
- 响应包含申请信息
- 设置环境变量: application_id = 响应中的申请id
